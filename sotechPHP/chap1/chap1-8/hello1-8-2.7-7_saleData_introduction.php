  ...
  *{
  ...
  .error{
    ...
    <div class="main-contents">
      ...
      <p>p.296</p>
      <p class="pdg"></p><!--  .pdg -->
      <h3>割引購入ページと金額ページ、そして両方で共有するデータファイル</h3>
      <p>ここでは3つのファイルを用意する。</p>
      <p>まず、割引購入ページ(discountForm.php)と金額ページ(discount.php)を用意しよう。</p>
      <p>最後に購入・金額ページ両方で共有するデータファイル(saledata.php)を用意するのだ。</p>
      <p>データファイルには、割引率の配列$couponListと価格の$priceListの2つの配列があり、</p>
      <p>クーポンコードで割引率を調べるgetCoupotRate()と</p>
      <p>商品IDで価格を調べるgetPrice()を定義する。</p>
